...
const statusFilter = [
  { value: "", labelKey: "reviews.filterAll" },
  { value: "approved", labelKey: "reviews.filterPublished" },
  { value: "pending", labelKey: "reviews.filterPending" },
  { value: "rejected", labelKey: "reviews.filterRejected" },
];
...
const statusBadgeLabelKeys: Record<string, string> = {
  approved: "reviews.badgePublished",
  pending: "reviews.badgePending",
  rejected: "reviews.badgeRejected",
  hidden: "reviews.badgeHidden",
};
...
export default function SellerReviewsPage() {
  ...
  const publishReply = (reviewId: number) => {
    ...
    replySellerReview(reviewId, content)
      ...
      .catch((err) => setError(err instanceof Error ? err.message : t("reviews.replyError")))
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 py-10">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{t("reviews.subtitle")}</p>
          </div>
        </div>
                ...
                <div key={review.id} className="rounded-2xl border border-gray-200 bg-white p-5">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {review.is_verified_purchase && (
                          <p className="text-xs text-emerald-600">{t("reviews.verifiedPurchase")}</p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-gray-500">
                    ...
                    <span className={`inline-flex rounded-full px-2 py-0.5 font-semibold ${
                      ...
                      {statusBadgeLabelKeys[review.status]
                        ? t(statusBadgeLabelKeys[review.status])
                        : review.status}
                    </span>
                  </div>
                    ...
                    <div className="mt-2 flex items-center justify-end gap-3">
                      {review.reply && (
                        <span className="text-xs text-emerald-600">
                          {t("reviews.replyPublishedAt", {
                            date: review.reply.updated_at
                      ...
                      >
                        ...
                        {review.reply ? t("reviews.updateReply") : t("reviews.publishReply")}
                      </button>
                    </div>
                  </div>
                </div>
