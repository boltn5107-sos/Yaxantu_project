...
class ProductSeeder extends Seeder
{
    ...
    private const MEDIA = [
        ...
        'arachides-grillees-1-kg' => [
            'photo-1563379926898-05f4575a45d8',
        ],
        'pagne-wax-premium' => [
            'photo-1515555230216-82228b88ea98',
            'photo-1524504388940-b1c1722653e1',
        ],
        'huile-de-karite-pure' => [
    ...
    public function run(): void
    {
        $sellers = collect([
            ...
            [
                'shop_name' => 'Terroir Sénégal',
                'email' => 'terroir@yaxantu.local',
                'description' => 'Céréales du pays, fruits à coque et artisanat.',
                'verified' => false,
            ],
        ...
        $products = [
            ...
            [
                'name' => 'Bracelet Sonko Artisanal',
                'seller' => 'terroir@yaxantu.local',
                'category' => 'mode-beaute',
                'price' => 2500,
                'stock' => 50,
                'featured' => true,
                'rating' => [4.9, 340],
                'short' => 'Bracelet tissé main, symbole de fierté citoyenne.',
                'description' => 'Bracelet artisanal tissé à la main en perles et fil de coton, emblème de soutien et de fierté citoyenne. Fabrication locale, longueur réglable.',
                'images' => 2,
            ],
            [
                'name' => 'Mil 1 kg',
                ...
                'featured' => true,
                'rating' => [4.7, 121],
                'short' => 'Mil trié, céréale traditionnelle.',
                'description' => 'Mil de première qualité, trié et séché au soleil. Idéal pour les bouillies, couscous et la cuisine traditionnelle.',
                'images' => 1,
            ],
            [
                'name' => 'Maïs 5 kg',
                ...
                'featured' => false,
                'rating' => [4.5, 64],
                'short' => 'Maïs jaune grain entier.', 
                'description' => 'Maïs jaune grain entier, récolté localement. Parfait pour les céréales, semoules et alimentation quotidienne.',
                'images' => 1,
            ],
            [
                'name' => 'Arachides Grillées 1 kg',
                'seller' => 'terroir@yaxantu.local',
                'category' => 'alimentation',
                'price' => 1500,
                'stock' => 120,
                'featured' => true,
                'rating' => [4.8, 197],
                'short' => 'Arachides fraîches, grillées à sec.',
                'description' => 'Arachides grillées à sec, sans ajout. Idéales en en-cas ou pour la préparation du mafé et des sauces.',
                'images' => 1,
            ],
            [
                ...
                'featured' => true,
                'rating' => [4.9, 86],
                'short' => 'Tissu wax 6 yards, motifs authentiques.',
                'description' => 'Pagne wax de qualité supérieure, 6 yards, motifs africains originaux. Résiste au lavage et garde ses couleurs.',
                'images' => 2,
            ],
            [
                ...
                'featured' => false,
                'rating' => [4.6, 74],
                'short' => 'Beurre de karité 100% naturel.',
                'description' => 'Beurre de karité brut extrait à la main par des coopératives sénégalaises. Nourrit la peau et les cheveux au naturel.',
                'images' => 1,
            ],
        ];
